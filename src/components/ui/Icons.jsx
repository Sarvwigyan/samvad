...
/**
 * Sovereign Symbolic Vector Icon Library for Samwad
 * Replaces cartoon emojis with crisp, minimal, symbolic SVG vector icons
 * modeled after X (Twitter) and modern high-end minimalist design.
 */

export function StreamIcon({ size = 20, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LibraryIcon({ size = 20, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function ReplyIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function RepostIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function MoreHorizontalIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TrendingIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function InfinityIcon({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function BellIcon({ size = 20, className = "", filled = false }) {
  return (
    <svg
      width={size}
      height={size}
...
export function MailIcon({ size = 20, className = "", filled = false }) {
  return (
    <svg
      width={size}
      height={size}
...
export function CheckCheckIcon({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function AtIcon({ size = 16, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function MicIcon({ size = 18, className = "", color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function StopCircleIcon({ size = 18, className = "", color = "currentColor" }) {
  return (
    <svg
      width={size}
      height={size}
